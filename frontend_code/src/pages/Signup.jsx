...
export default function SignupPage() {
  ...
  const onSubmit = async (e) => {
    ...
    try {
      const { data, status } = await axios.post(`/signup`, {
        username: state.username,
        password: state.password,
      });

      console.log(`user created`, data, status);

      Swal.fire({
        title: "OK, Account Created!",
      ...
      <div className="w-full max-w-sm mx-auto py-12 px-1 md:px-0 ">
        ...
        >
          <h2 className="py-4 mx-auto w-full mt-4 mb-4 content-center text-center text-2xl ">
            <i className="fas fa-user-alt mr-2"></i> Create new Account
          </h2>
          ...
          <div className="flex mx-auto justify-around">
            <button
              ...
              type="submit"
            >
              <i className="fas fa-user-alt mr-2"></i> Signup
            </button>
